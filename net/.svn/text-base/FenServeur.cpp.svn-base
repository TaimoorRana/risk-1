...
void FenServeur::nouvelleConnexion()
{
    ...
    QList<int> l;
    l << playerid;
    sendTo(l,"2Welcome to the chat, your player id is "+pid);
...
void FenServeur::donneesRecues()
{
    ...
    std::cout << "Donnees recues du client: " << message.toStdString() << std::endl;
...
void FenServeur::sendTo(const QList<int> playerids,const QString &message)
{
    // Préparation du paquet
    QByteArray packet;
    ...
    for (int i = 0; i < playerids.size(); i++)
    {
        ...
        (map.value(playerids[i]))->write(packet);
